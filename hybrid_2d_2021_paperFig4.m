...
%Desired Cell
xSC = 60*[1,1,1,1,1,1,1];%%10+[20,40,60,80];
TDthickness = 3;
FSbeamthickness = 100;
...
zSC = [nz/2 + 3*TDthickness,nz/2 + 2*TDthickness,nz/2 + 1*TDthickness ,nz/2 , nz/2 - 1*TDthickness, nz/2 - 2*TDthickness, nz/2 - 3*TDthickness]-1;
...
for t=1:nt
  ...
  [ha,~] = tight_subplot(plot_height,plot_width,[0.00 -0.333],0.125,0.0);
% % % % % % % % % % % % % %       % %5Get Cell
