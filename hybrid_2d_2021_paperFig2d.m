...
fig = figure('Position',[ 1 1 1900 850]);
outputFolder = '184';
...
moverq=1.0378e-8;
fileName = strcat('/import/c1/DAYSIDE/atvu/Runs/2d_Hybrid_Foreshock_paperFig2_Jperp_',RunNumber,'_',string(xcut));
...
for i=1:stepInterval:nt
    [ha,~] = tight_subplot(plot_height,plot_width,[0.06 0.01],0.1,0.1);
...
%     
    ...
    colorbar; title('\DeltaJperpx_{sw}/J0','FontSize', 14);
...
%     xlabel({'X';'[\lambda_i]'},'FontSize',14)
    ...
    axes(ha(axes_count));axes_count=axes_count+1;
    pcolor(delta_electron_perpx(nz_min:nz_max,nx_min:nx_max)); shading interp
    colorbar; title('\DeltaJperpx_{e}/J0','FontSize', 14);
    set(gca,'YDir','normal');ylim(ylimits),xlim(xlimits);
    caxis([-max(abs(caxis)) max(abs(caxis))])
    set(gca,'XMinorTick','on','TickDir','out','YMinorTick','on','linewidth',2)
...
%     xlabel({'X';'[\lambda_i]'},'FontSize',14)
    ...
    colorbar; title('Jperpx_{fs}/J0','FontSize', 14);
    set(gca,'YDir','normal');ylim(ylimits),xlim(xlimits);
    caxis([-max(abs(caxis)) max(abs(caxis))])
    set(gca,'XMinorTick','on','TickDir','out','YMinorTick','on','linewidth',2)
    set(gca,'YTickLabel',[]);set(gca,'XTickLabel',[])
%     xlabel({'X';'[\lambda_i]'},'FontSize',14)
    ...
    axes(ha(axes_count));axes_count=axes_count+1;
    pcolor(Jperpx_tot_woJd(nz_min:nz_max-1,nx_min:nx_max-1)); shading interp
    colorbar; title('\DeltaJperpx_{tot}/J0','FontSize', 14);
    set(gca,'YDir','normal');ylim(ylimits),xlim(xlimits);
    caxis([-max(abs(caxis)) max(abs(caxis))])
    set(gca,'XMinorTick','on','TickDir','out','YMinorTick','on','linewidth',2)
    set(gca,'YTickLabel',[]);set(gca,'XTickLabel',[])
...
%     xlabel({'X';'[\lambda_i]'},'FontSize',14)
    ...
    colorbar; title('\DeltaJperpy_{sw}/J0','FontSize', 14);
    set(gca,'YDir','normal');ylim(ylimits),xlim(xlimits);
    caxis([-max(abs(caxis)) max(abs(caxis))])
    set(gca,'XMinorTick','on','TickDir','out','YMinorTick','on','linewidth',2)
%     set(gca,'YTickLabel',[])
    ...
    axes(ha(axes_count));axes_count=axes_count+1;
    pcolor(delta_electron_perpy(nz_min:nz_max,nx_min:nx_max)); shading interp
    colorbar; title('\DeltaJperpy_{e}/J0','FontSize', 14);
    set(gca,'YDir','normal');ylim(ylimits),xlim(xlimits);
    caxis([-max(abs(caxis)) max(abs(caxis))])
    set(gca,'XMinorTick','on','TickDir','out','YMinorTick','on','linewidth',2)
    set(gca,'YTickLabel',[])
    ...
    colorbar; title('Jperpy_{fs}/J0','FontSize', 14);
    set(gca,'YDir','normal');ylim(ylimits),xlim(xlimits);
    caxis([-max(abs(caxis)) max(abs(caxis))])
    set(gca,'XMinorTick','on','TickDir','out','YMinorTick','on','linewidth',2)
    set(gca,'YTickLabel',[])
    ...
    axes(ha(axes_count));axes_count=axes_count+1;
    pcolor(Jperpy_tot_woJd(nz_min:nz_max-1,nx_min:nx_max-1)); shading interp
    colorbar; title('\DeltaJperpy_{tot}/J0','FontSize', 14);
    set(gca,'YDir','normal');ylim(ylimits),xlim(xlimits);
    caxis([-max(abs(caxis)) max(abs(caxis))])
    set(gca,'XMinorTick','on','TickDir','out','YMinorTick','on','linewidth',2)
    set(gca,'YTickLabel',[])
...
% % % % % %     hold on
% % % % % % %     plot(smooth(jDx_cold(:,xcut)),'b--','linewidth',1)
% % % % % %     plot(smooth(delta_electron_perpx_cold(2:end-1,xcut)+delta_electron_perpx_mixed(2:end-1,xcut)),'b--','linewidth',1)
% % % % % %     ylim([ -max(abs(ylim)) max(abs(ylim)) ])
% % % % % %     %     plot(smooth(jDx_cold(:,xcut)),'linewidth',1)
% % % % % %     %     plot(smooth(delta_electron_perpx(2:end-1,xcut)),'linewidth',1)
% % % % % % %     yyaxis right
...
% % % % % %     ylabel({'Jperpx/J0'},'FontSize',14)
% % % % % %     xlim(zrange)
% % % % % %     Alegend = legend('\Delta(nqu)_{sw}','\Delta(nqu)_{e}','(nqu)_{fs}','Location','northwest','Orientation','horizontal'); legend('boxoff')
...
% % % % % % %     xlim(zrange)
% % % % % % %     set(gca,'xminortick','on','yminortick','on','linewidth',1.5,'XTickLabel',[])
% % % % % % %     AAlegend = legend('(nqu_i)_{sw} - (nqu_e)_{sw}','(nqu_i)_{fs} - (nqu_e)_{fs}','Location','northwest','Orientation','horizontal'); legend('boxoff')
...
% % % % % %     xlim(zrange)
% % % % % %     set(gca,'xminortick','on','yminortick','on','linewidth',1.5,'XTickLabel',[])
% % % % % %     Blegend = legend('\Delta(nqu)_{sw} + \Delta(nqu)_e + (nqu)_{fs}','\DeltaJperp','Location','northwest','Orientation','horizontal'); legend('boxoff')
% % % % % % %     Clegend = legend('Jperptot wo. gradPe','Jperptot w. gradPe','\DeltaJperp','Location','northwest','Orientation','horizontal'); legend('boxoff')
% % % % % % 
% % % % % %     
% % % % % %     axes(ha(axes_count));axes_count=axes_count+1;
...
% % % % % %     hold on
% % % % % % %     plot(smooth(jDy_cold(:,xcut)),'b--','linewidth',1)
% % % % % %     plot(smooth(delta_electron_perpy_cold(2:end-1,xcut)+delta_electron_perpy_mixed(2:end-1,xcut)),'b--','linewidth',1)
% % % % % %     ylim([ -max(abs(ylim)) max(abs(ylim)) ])
% % % % % % %     hold on;
% % % % % %     %     plot(smooth(jDy_cold(:,xcut)),'linewidth',1)
% % % % % %     %     plot(smooth(delta_electron_perpy(2:end-1,xcut)),'linewidth',1)
...
% % % % % %     ylabel({'Jperpy/J0'},'FontSize',14)
% % % % % %     xlim(zrange)
% % % % % %     Clegend = legend('\Delta(nqu)_{sw}','\Delta(nqu)_{e}','(nqu)_{fs}','Location','northwest','Orientation','horizontal'); legend('boxoff')
...
% % % % % % %     xlim(zrange)
% % % % % % %     set(gca,'xminortick','on','yminortick','on','linewidth',1.5,'XTickLabel',[])
% % % % % % %     CClegend = legend('(nqu_i)_{sw} - (nqu_e)_{sw}','(nqu_i)_{fs} - (nqu_e)_{fs}','Location','northwest','Orientation','horizontal'); legend('boxoff')
% % % % % % %     %     Clegend = legend('Jperptot wo. gradPe','Jperptot w. gradPe','\DeltaJperp','Location','northwest','Orientation','horizontal'); legend('boxoff')
% % % % % %     
% % % % % %     
% % % % % %     
...
% % % % % %     Dlegend = legend('\Delta(nqu)_{sw} + \Delta(nqu)_e + (nqu)_{fs}','\DeltaJperp','Location','northwest','Orientation','horizontal'); legend('boxoff')
