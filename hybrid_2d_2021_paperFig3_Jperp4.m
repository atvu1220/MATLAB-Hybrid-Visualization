...
%     
    ...
    xlim(zrange)
    Alegend = legend('\Delta(nqu)_{sw}','jD_{sw}','(nqu)_{fs}','jD_{fs}','Location','northwest','Orientation','horizontal'); legend('boxoff')
...
%     plot(smooth(Jperpx_tot_wJd(:,xcut)),'b--','linewidth',1)
    ...
    xlim(zrange)
    set(gca,'xminortick','on','yminortick','on','linewidth',1.5,'XTickLabel',[])
    Blegend = legend('(nqu)_{sw} + (nqu)_{fs}','\DeltaJperp-(nqu)_e','Location','northwest','Orientation','horizontal'); legend('boxoff')
%     Clegend = legend('Jperptot wo. gradPe','Jperptot w. gradPe','\DeltaJperp','Location','northwest','Orientation','horizontal'); legend('boxoff')
    ...
    xlim(zrange)
    Clegend = legend('\Delta(nqu)_{sw}','jD_{sw}','(nqu)_{fs}','jD_{fs}','Location','northwest','Orientation','horizontal'); legend('boxoff')
...
%     plot(smooth(Jperpy_tot_wJd(:,xcut)),'b--','linewidth',1)
    ...
    xlim(zrange)
    set(gca,'xminortick','on','yminortick','on','linewidth',1.5,'XTickLabel',[])
    Dlegend = legend('(nqu)_{sw} + (nqu)_{fs}','\DeltaJperp-(nqu)_e','Location','northwest','Orientation','horizontal'); legend('boxoff')
