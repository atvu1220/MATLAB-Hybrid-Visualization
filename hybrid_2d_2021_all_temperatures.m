...
%     caxis([0.0 0.1])
   ...
   %% u cold 
    ...
    [Bxdata_interp] = (interpolate_Data(Bdata,1,i,nx,nz,X,Z,X2,Z2)-1*interpolate_Data(Bdata,1,1,nx,nz,X,Z,X2,Z2)).*moverq./(5e-9);
    ...
    axes(ha(11));
    [Bydata_interp] = (interpolate_Data(Bdata,2,i,nx,nz,X,Z,X2,Z2)-1*interpolate_Data(Bdata,2,1,nx,nz,X,Z,X2,Z2)).*moverq./(5e-9);
