...
moverq=1.0378e-8;
fileName = strcat('/import/c1/DAYSIDE/atvu/Runs/2d_Hybrid_Foreshock_Jperp11_',RunNumber,'_',string(xcut));
...
filterNumber = 0.1;
filterNumber2 = 0.01;
filterNumber3 = 1; %Particle J
filterNumber4=1; %J current and B
filterNumber5=1; %u and Ji-Je
%% Initial State
