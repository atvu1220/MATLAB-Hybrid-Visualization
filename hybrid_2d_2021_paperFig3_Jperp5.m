...
moverq=1.0378e-8;
fileName = strcat('/import/c1/DAYSIDE/atvu/Runs/2d_Hybrid_Foreshock_Jperp_minusElectrons2_',RunNumber,'_',string(xcut));
...
%     plot(smooth(jDx_mixed(:,xcut)),'r--','linewidth',1)
    ...
    ylabel({'Jperpx/J0'},'FontSize',14)
    xlim(zrange)
    Alegend = legend('\Delta(nqu_i)_{sw}','\Delta(nqu_e)_{sw}','(nqu_i)_{fs}','(nqu_e)_{fs}','Location','northwest','Orientation','horizontal'); legend('boxoff')
...
%     plot(smooth(Jperpx_tot_wJd(:,xcut)),'b--','linewidth',1)
    ...
    xlim(zrange)
    set(gca,'xminortick','on','yminortick','on','linewidth',1.5,'XTickLabel',[])
    Blegend = legend('(nqu)_{sw} + (nqu)_{fs}','\DeltaJperp','Location','northwest','Orientation','horizontal'); legend('boxoff')
%     Clegend = legend('Jperptot wo. gradPe','Jperptot w. gradPe','\DeltaJperp','Location','northwest','Orientation','horizontal'); legend('boxoff')
...
%     plot(smooth(jDy_mixed(:,xcut)),'r--','linewidth',1)
    ...
    ylabel({'Jperpy/J0'},'FontSize',14)
    xlim(zrange)
    Clegend = legend('\Delta(nqu_i)_{sw}','\Delta(nqu_e)_{sw}','(nqu)_{fs}','(nqu_e)_{fs}','Location','northwest','Orientation','horizontal'); legend('boxoff')
...
%     plot(smooth(Jperpy_tot_wJd(:,xcut)),'b--','linewidth',1)
    ...
    Dlegend = legend('(nqu)_{sw} + (nqu)_{fs}','\DeltaJperp','Location','northwest','Orientation','horizontal'); legend('boxoff')
