...
moverq=1.044e-8;
fileName = strcat('/import/c1/DAYSIDE/atvu/Runs/2d_Hybrid_Foreshock_all_Run',RunNumber);
...
%     plot2 = subplot(plot_height,plot_width,plot_number); plot_number = plot_number+1;
    ...
    %clear Tdata_interp
    colorbar; title('T/T_0','FontSize', 14);
...
% figure; plot(Bxdata_interp(:,nx-5)./sqrt(Bxdata_interp(:,nx-5).^2 + Bydata_interp(:,nx-5).^2))
    ...
    colorbar; title('(Bx-Bx_0)/B_0','FontSize', 14)
    %      shading interp
    set(gca,'YDir','normal');ylim(ylimits),xlim(xlimits);
...
%     plot8 = subplot(plot_height,plot_width,plot_number); plot_number = plot_number+1;
    ...
    colorbar; title('(By-By_0)/B_0','FontSize', 14)
    %      shading interp
    set(gca,'YDir','normal');ylim(ylimits),xlim(xlimits);
    caxis([-.25 .25]);%ylim(ylimits)
    set(gca,'XMinorTick','on','TickDir','out','YMinorTick','on','linewidth',2)
...
%     plot9 = subplot(plot_height,plot_width,plot_number); plot_number = plot_number+1;
    ...
    colorbar; title('Bz/B_0','FontSize', 14)
    %      shading interp
    set(gca,'YDir','normal');ylim(ylimits),xlim(xlimits);
    caxis([-.25 .25]);%ylim(ylimits)
    set(gca,'XMinorTick','on','TickDir','out','YMinorTick','on','linewidth',2)
...
%     clear Jxdata_interp
    colorbar; title('Jx','FontSize', 14);%ylim(ylimits)
    set(gca,'YDir','normal');ylim(ylimits),xlim(xlimits);
    %      shading interp
    caxis([-2 2])
    set(gca,'XMinorTick','on','TickDir','out','YMinorTick','on','linewidth',2)    
...
%     clear Jydata_interp
    colorbar; title('Jy','FontSize', 14);%ylim(ylimits)
    set(gca,'YDir','normal');ylim(ylimits),xlim(xlimits);
    %      shading interp
    caxis([-2 2]);
    set(gca,'XMinorTick','on','TickDir','out','YMinorTick','on','linewidth',2)
