...
moverq=1.0378e-8;
fileName = strcat('/import/c1/DAYSIDE/atvu/Runs/2d_Hybrid_Foreshock_Jperp9_unsmooth2_uexBxB_',RunNumber,'_',string(xcut));
...
filterNumber = 0.00001;
filterNumber2 = 0.00001;
%% Initial State
...
%     legend('x','y','z','Location','northeast','Orientation','horizontal'); legend('boxoff')
    ...
    delta_Jperpx_minus_delta_electron_perpx = imgaussfilt(delta_Jperpx_minus_delta_electron_perpx,filterNumber);
    ...
    delta_Jperpy_minus_delta_electron_perpy = imgaussfilt(delta_Jperpy_minus_delta_electron_perpy,filterNumber);
    ...
    %% Draw
    drawnow
%         fileNamePNG = strcat('/import/c1/DAYSIDE/atvu/Runs/',RunNumber,'/','2d_Hybrid_Foreshock_ExBeflow_',RunNumber,'_',string(i));
