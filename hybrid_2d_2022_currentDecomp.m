...
timeSteps = 5000;
outputSteps = 25;
target_time = timeSteps/outputSteps;
...
[n_cold_data] = read_Plasma('n_cold',nt,nx,ny,nz,outputDirectory);
disp('n cold loaded')
[n_mixed_data] = read_Plasma('n_cold_foreshock',nt,nx,ny,nz,outputDirectory);
disp('n foreshock loaded')
[up_cold_data] = read_Plasma('up_cold',nt,nx,ny,nz,outputDirectory);
disp('u cold loaded')
[up_mixed_data] = read_Plasma('up_cold_foreshock',nt,nx,ny,nz,outputDirectory);
disp('u foreshock loaded')
...
%JdotE
    ...
    hold off
    yyaxis left
    plot(smooth((n_cold_data_interp_plot(2:end-1,xcut)-n_cold_data_interp0_plot(2:end-1,xcut))./n0),'b','linewidth',1)
    hold on
...
%     ylim([ -max(abs(ylim)) max(abs(ylim)) ])
    ...
    nlegend = legend('bot','top','Location','northeast','Orientation','horizontal','fontsize',12); legend('boxoff')
...
%     
    ...
    set(gca,'xminortick','on','yminortick','on','linewidth',1.5,'XTickLabel',[])
    AAlegend = legend('bot','top','Location','northeast','Orientation','horizontal','fontsize',12); legend('boxoff')
...
%     legend('\Deltau_{sw}','\Deltau_{e}','u_{fs}','Location','northeast','Orientation','horizontal'); legend('boxoff')
    ...
    set(gca,'xminortick','on','yminortick','on','linewidth',1.5,'XTickLabel',[])
    CClegend = legend('bot','top','Location','northeast','Orientation','horizontal','fontsize',12); legend('boxoff')
    ...
    set(gca,'xminortick','on','yminortick','on','linewidth',1.5); xlabel({'Z','[\lambda_i]'},'FontSize',14)
    Dlegend = legend('bot','top','Location','northeast','Orientation','horizontal','fontsize',12); legend('boxoff')
